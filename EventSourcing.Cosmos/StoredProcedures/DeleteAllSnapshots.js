 ...
 * @param {int} recordKind - The integer corresponding to the RecordKind value 'Snapshot'
 ...
 */
function deleteAllSnapshots(containerId, partitionId, aggregateId, recordKind) {
